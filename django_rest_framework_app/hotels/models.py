...
#     return '/'.join(['images',
#                      hashlib.md5(instance.name).hexdigest(), filename])
...
class Review(models.Model):
    ...
    likes = models.ManyToManyField(BaseUser)
...
class Hotel(BaseUser):
    ...
    def stays_count(self):
        return self.stay_set.count()

    def update_avg_rating(self):
        self.avg_rating = self.stay_set.aggregate(
